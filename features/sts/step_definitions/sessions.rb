...
Then /^I should not be able to use the returned credentials to make SQS requests$/ do
  lambda { AWS_SDK::SQS.new(@result.credentials).queues.to_a }.
    should raise_error(AWS_SDK::SQS::Errors::AccessDenied)
end
