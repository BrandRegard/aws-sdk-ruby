...
After("@ec2") do
  ...
  @created_customer_gateways.each do |gateway|
    begin
      gateway.delete  
    rescue AWS_SDK::EC2::Errors::InvalidCustomerGatewayID::NotFound
      # already deleted
    end
  end
  ...
  @created_internet_gateways.each do |gateway|
    begin
      gateway.vpc = nil
      gateway.delete
    rescue AWS_SDK::EC2::Errors::InvalidInternetGatewayID::NotFound
      # already deleted
    end
  end
  ...
  @started_instances.each do |instance|
    begin
      instance.terminate
    rescue AWS_SDK::EC2::Errors::OperationNotPermitted
  ...
  @created_security_groups.each{|group|
    begin
      group.delete
    rescue AWS_SDK::EC2::Errors::InvalidSecurityGroupID::NotFound,
           AWS_SDK::EC2::Errors::InvalidGroup::NotFound
      # already deleted
    end
  }
  ...
  @created_images.each do |image|
    begin
      image.delete
    rescue AWS_SDK::EC2::Errors::InvalidImageID::NotFound,
           AWS_SDK::EC2::Errors::InvalidAMIID::Unavailable
      # already deleted
    end
  end
  ...
  @created_volumes.each do |volume|
    begin
      volume.delete
    rescue AWS_SDK::EC2::Errors::InvalidVolumeID::NotFound,
      AWS_SDK::EC2::Errors::InvalidVolume::NotFound
      # already deleted
    end
  end
  ...
  @created_snapshots.each do |snapshot|
    begin
      snapshot.delete
    rescue AWS_SDK::EC2::Errors::InvalidSnapshotID::NotFound,
           AWS_SDK::EC2::Errors::InvalidSnapshot::NotFound
      # already deleted
    end
  end
  ...
  unless @created_subnets.empty?
    ...
    @created_subnets.each do |subnet|
      begin
        subnet.delete
      rescue AWS_SDK::EC2::Errors::InvalidSubnetID::NotFound
  ...
  @created_route_tables.each do |table|
    begin
      table.delete
    rescue AWS_SDK::EC2::Errors::InvalidRouteTableID::NotFound
  ...
  @created_vpcs.each do |vpc|
    begin
      vpc.delete
    rescue AWS_SDK::EC2::Errors::InvalidVpcID::NotFound
      # already deleted
    end
  end
  ...
  @created_dhcp_options.each do |opts|
    begin
      opts.delete
    rescue AWS_SDK::EC2::Errors::InvalidDhcpOptionsID::NotFound
      # already deleted
    end
  end
