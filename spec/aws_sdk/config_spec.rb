  ...
  context 'configuration' do
    ...
    context 'options' do
      ...
      context ':credential_provider' do
        ...
        it 'defaults to an AWS_SDK::Core::CredentialProviders::DefaultProvider' do
          config.credential_provider.should 
            be_a(AWS_SDK::Core::CredentialProviders::DefaultProvider)
        end
      ...
      context ':http_handler' do
        ...
        it 'defaults to a NetHttpHandler' do
          ...
          handler.should be_a(AWS_SDK::Core::Http::NetHttpHandler)
      ...
      context ':log_formatter' do
        ...
        it 'defaults to the default log formatter' do
          config.log_formatter.should eq(AWS_SDK::Core::LogFormatter.default)
        end
