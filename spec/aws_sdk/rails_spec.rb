      ...
      context 'add_action_mailer_delivery_method' do
        ...
        it 'adds an :amazon_ses delivery method' do
          ActionMailer::Base.should_receive(:add_delivery_method).
            with(:amazon_ses, AWS_SDK::SimpleEmailService, {})
          AWS_SDK::Rails.add_action_mailer_delivery_method
        end
        ...
        it 'returns nil' do
          AWS_SDK::Rails.add_action_mailer_delivery_method.should == nil
        end
        ...
        context 'older rails' do
          ...
          it 'the added method calls send_raw_email' do
            ...
            AWS_SDK::SimpleEmailService.should_receive(:new).with({}).and_return(ses)
