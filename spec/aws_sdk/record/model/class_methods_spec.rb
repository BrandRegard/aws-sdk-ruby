    ...
    describe Model do
      ...
      context 'create_domain' do
        ...
        it 'should call create on the domain collection' do
          ...
          AWS_SDK::SimpleDB.stub_chain(:new, :domains).and_return(domains)
      ...
      context 'sdb_domain' do
        ...
        it 'returns a sdb domain object' do
          klass.sdb_domain.should be_a(AWS_SDK::SimpleDB::Domain)
        end
        ...
        it 'returns a domain with a prefixed shard name when configured' do
          AWS_SDK::Record.stub(:domain_prefix).and_return('prefixed')
          klass.sdb_domain.name.should == "prefixed#{klass.shard_name}"
        end

      end

      it_should_behave_like("record class", AWS_SDK::Record::Model) do
  
        # specific to AWS_SDK::Record::Model
