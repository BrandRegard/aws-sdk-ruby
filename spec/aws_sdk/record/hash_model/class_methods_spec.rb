  ...
  module Record
    describe Model do
      ...
      context 'create_table' do
        ...
        it 'prefixes the shard name with AWS_SDK::Record.table_prefix' do
          AWS_SDK::Record.stub(:table_prefix).and_return('prefix-')
          tables.should_receive(:create).with(
      ...
      context 'dynamo_db_table' do
        ...
        it 'returns a table object' do
          klass.dynamo_db_table.should be_a(AWS_SDK::DynamoDB::Table)
        end
        ...
        it 'applies the table prefix to the shard name' do
          AWS_SDK::Record.stub(:table_prefix).and_return('test-')
      ...
      context '[]' do
        ...
        it 'removes the table prefix' do 
          AWS_SDK::Record.stub(:table_prefix).and_return('prefixed-')
