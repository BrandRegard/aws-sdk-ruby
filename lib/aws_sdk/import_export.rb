...
module AWS_SDK
  ...
  #
  # Or you can set them directly on the AWS_SDK::ImportExport interface:
  #
  #   ie = AWS_SDK::ImportExport.new(
  #     :access_key_id => 'YOUR_ACCESS_KEY_ID',
  #     :secret_access_key => 'YOUR_SECRET_ACCESS_KEY')
  #
  # = Using the Client
  #
  # AWS_SDK::ImportExport does not provide higher level abstractions for Import/Export at
  # this time.  You can still access all of the API methods using
  # {AWS_SDK::ImportExport::Client}.  Here is how you access the client and make
  # a simple request:
  #
  #   ie = AWS_SDK::ImportExport.new
  #
  ...
  class ImportExport
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/import_export') do
