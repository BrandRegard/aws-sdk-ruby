...
module AWS_SDK
  module Core
    ...
    #   response.http_request #=> #<AWS_SDK::Core::Http::Request>
    #   response.http_response #=> #<AWS_SDK::Core::Http::Response>
    #
    class Response
      ...
      # @return [AWS_SDK::Error,nil] Returns nil unless the request failed.
