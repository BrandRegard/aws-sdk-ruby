...
module AWS_SDK
  class CloudFormation
    ...
    class Client < Core::QueryClient
      ...
      #     AWS_SDK::IAM::AccessKey, AWS_SDK::IAM::Group, AWS_SDK::IAM::Policy,
      #     AWS_SDK::IAM::User, and AWS_SDK::IAM::UserToGroupAddition.
      ...
      #     IAM resources are the following: AWS_SDK::IAM::AccessKey,
      #     AWS_SDK::IAM::Group, AWS_SDK::IAM::Policy, AWS_SDK::IAM::User, and
      #     AWS_SDK::IAM::UserToGroupAddition.
      # @return [Core::Response]
      #   The #data method of the response object returns
      #   a hash with the following structure:
      #   * +:stack_id+ - (String)
