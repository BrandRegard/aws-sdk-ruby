...
module AWS_SDK
  ...
  #
  # Or you can set them directly on the AWS_SDK::Route53 interface:
  #
  #   cs = AWS_SDK::CloudSearch.new(
  #     :access_key_id => 'YOUR_ACCESS_KEY_ID',
  #     :secret_access_key => 'YOUR_SECRET_ACCESS_KEY')
  #
  # = Using the Client
  #
  # AWS_SDK::CloudSearch does not provide higher level abstractions for CloudSearch at
  # this time.  You can still access all of the API methods using
  # {AWS_SDK::CloudSearch::Client}.  Here is how you access the client and make
  # a simple request:
  #
  #   cs = AWS_SDK::CloudSearch.new
  #
  ...
  class CloudSearch
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/cloud_search') do
