...
module AWS_SDK
  ...
  #
  #   cw = AWS_SDK::CloudWatch.new(
  #     :access_key_id => 'YOUR_ACCESS_KEY_ID',
  #     :secret_access_key => 'YOUR_SECRET_ACCESS_KEY')
  #
  # = Using the Client
  #
  # AWS_SDK::CloudWatch does not provide higher level abstractions for CloudWatch at
  # this time.  You can still access all of the API methods using
  # {AWS_SDK::CloudWatch::Client}.  Here is how you access the client and make
  # a simple request:
  #
  #   cw = AWS_SDK::CloudWatch.new
  #
  ...
  class CloudWatch
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/cloud_watch') do
