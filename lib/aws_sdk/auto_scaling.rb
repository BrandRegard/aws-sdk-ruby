...
module AWS_SDK
  ...
  #
  # Or you can set them directly on the AWS_SDK::AutoSclaing interface:
  #
  #   auto_scaling = AWS_SDK::AutoScaling.new(
  #     :access_key_id => 'YOUR_ACCESS_KEY_ID',
  #     :secret_access_key => 'YOUR_SECRET_ACCESS_KEY')
  #
  ...
  class AutoScaling
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/auto_scaling') do
