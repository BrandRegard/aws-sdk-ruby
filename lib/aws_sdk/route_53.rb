...
module AWS_SDK
  ...
  #
  #   r53 = AWS_SDK::Route53.new(
  #     :access_key_id => 'YOUR_ACCESS_KEY_ID',
  #     :secret_access_key => 'YOUR_SECRET_ACCESS_KEY')
  #
  # = Using the Client
  #
  # AWS_SDK::Route53 does not provide higher level abstractions for Route 53 at
  # this time.  You can still access all of the API methods using
  # {AWS_SDK::Route53::Client}.  Here is how you access the client and make
  # a simple request:
  #
  #   r53 = AWS_SDK::Route53.new
  #
  ...
  class Route53
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/route_53') do
