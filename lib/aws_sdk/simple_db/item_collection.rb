...
module AWS_SDK
  class SimpleDB
    ...
    class ItemCollection
      ...
      #
      # * AWS_SDK::SimpleDB::Item objects (only the item name is populated)
      # * AWS_SDK::SimpleDB::ItemData objects (some or all attributes populated)
      #
      ...
      #     puts item.name
      #     puts item.class.name # => AWS_SDK::SimpleDB::Item
      #   end
      #
      ...
      #     puts item_data.class.name # => AWS_SDK::SimpleDB::ItemData
