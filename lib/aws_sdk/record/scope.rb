...
module AWS_SDK
  module Record
    ...
    # Base class for {AWS_SDK::Record::Model::Scope} and
    # {AWS_SDK::Record::HashModel::Scope}.
    class Scope
  
      include Enumerable
      
      # @param base_class A class that extends {AWS_SDK::Record::AbstractBase}.
      # @param [Hash] options
      # @option options :
      # @private
      ...
      # @return [Class] Returns the AWS_SDK::Record::Model extending class that
