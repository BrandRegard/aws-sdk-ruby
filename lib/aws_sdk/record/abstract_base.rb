...
require 'aws_sdk/record/scope'
require 'aws_sdk/record/naming'
require 'aws_sdk/record/validations'
require 'aws_sdk/record/dirty_tracking'
require 'aws_sdk/record/conversion'
require 'aws_sdk/record/errors'
require 'aws_sdk/record/exceptions'
  ...
  module Record
    module AbstractBase
      ...
      module InstanceMethods
        ...
        # an exception (AWS_SDK::Record::InvalidRecordError) if the record is not 
        # valid.
      ...
      module ClassMethods
        ...
        def shard_name name = nil
          ...
          when AWS_SDK::DynamoDB::Table
            name.name.gsub(/^#{Record::table_prefix}/, '')
          when AWS_SDK::SimpleDB::Domain
