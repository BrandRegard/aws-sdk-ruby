...
module AWS_SDK
  module Record
    class HashModel
      ...
      # The primary interface for finding records with {AWS_SDK::Record::HashModel}.
      #
      # == Getting a Scope Object
      #
      # You should normally never need to construct a Scope object directly.
      # Scope objects are returned from the AWS_SDK::Record::HashModel finder 
      # methods # (e.g. +shard+ and +limit+).
      #
      #   books = Book.limit(100)
      #   books.class #=> AWS_SDK::Record::HashModel::Scope
      #
      # Scopes are also returned from methods defined with the +scope+ method.
      #
      #   class Book < AWS_SDK::Record::HashModel
