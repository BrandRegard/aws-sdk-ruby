...
require 'aws_sdk/record/hash_model/scope'
require 'aws_sdk/record/hash_model/attributes'
require 'aws_sdk/record/hash_model/finder_methods'
  ...
  module Record
    class HashModel
      ...
      class << self
        ...
        # collisions:
        #
        #   AWS_SDK::Record.table_prefix = 'myapp-'
        #
        ...
        #   shard name will be prefixed with {AWS_SDK::Record.table_prefix},
