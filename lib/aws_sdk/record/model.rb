...
require 'aws_sdk/record/abstract_base'
require 'aws_sdk/record/model/scope'
require 'aws_sdk/record/model/attributes'
require 'aws_sdk/record/model/finder_methods'
...
module AWS_SDK
  module Record
    ...
    #
    #   class Book < AWS_SDK::Record::Model
    #
    #     string_attr :title
    #     string_attr :author
    ...
    # = Attribute Macros
    #
    # When extending AWS_SDK::Record::Model you should first consider what
    # attributes your class should have.  Unlike ActiveRecord, AWS_SDK::Record
    ...
    #
    # AWS_SDK::Record permits storing multiple values with a single attribute.
    #
    #   class Book < AWS_SDK::Record::Model
    ...
    # your data clean.  AWS_SDK::Record supports most of the ActiveRecord style
    # validators.
    #
    #   class Book < AWS_SDK::Record::Model
    #     string_attr :title
    ...
    class Model
      ...
      class << self
        ...
        #
        #   class Product < AWS_SDK::Record::Model
        #   end
        #
        ...
        #
        #   AWS_SDK::Record.domain_prefix = 'myapp-'
        #
        ...
        # class name.
        #
        #   AWS_SDK::Record.domain_prefix = 'prod-'
        #   class Product < AWS_SDK::Record::Model
        ...
        # @return [AWS_SDK::SimpleDB::Domain]
        # @private
        ...
        def sdb_domain_name shard_name = nil
          "#{AWS_SDK::Record.domain_prefix}#{self.shard_name(shard_name)}"
        end

        protected
        def sdb
          AWS_SDK::SimpleDB.new
        end
    ...
    # for backwards compatability with the old AWS_SDK::Record::Base
    Base = Model
