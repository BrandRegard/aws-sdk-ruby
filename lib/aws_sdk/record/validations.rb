...
require 'aws_sdk/record/validators/acceptance'
require 'aws_sdk/record/validators/block'
require 'aws_sdk/record/validators/confirmation'
require 'aws_sdk/record/validators/count'
require 'aws_sdk/record/validators/exclusion'
require 'aws_sdk/record/validators/format'
require 'aws_sdk/record/validators/inclusion'
require 'aws_sdk/record/validators/length'
require 'aws_sdk/record/validators/numericality'
require 'aws_sdk/record/validators/presence'
require 'aws_sdk/record/validators/method'

module AWS_SDK
  module Record

    # Validation methods to be used with subclasses of AWS_SDK::Record::Model.
    #
    # = General Usage
    #
    ...
    module Validations
      ...
      # is checked.
      #
      #   class User < AWS_SDK::Record::Model
      ...
      #
      #   class ExampleClass < AWS_SDK::Record::Model
      #
      #     string_attr :name
      #
      ...
      # object.
      #
      #   class MultipleChoiceAnswer < AWS_SDK::Record::Model
