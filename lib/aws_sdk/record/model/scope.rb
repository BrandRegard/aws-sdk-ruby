...
module AWS_SDK
  module Record
    class Model
      ...
      # The primary interface for finding records with {AWS_SDK::Record::Model}.
      #
      # == Getting a Scope Object
      #
      # You should normally never need to construct a Scope object directly.
      # Scope objects are returned from the AWS_SDK::Record::Model finder methods
      # (e.g. +shard+, +where+, +order+, +limit+, etc).
      #
      #   books = Book.where(:author => 'John Doe')
      #   books.class #=> AWS_SDK::Record::Scope, not Array
      #
      ...
      class Scope < Record::Scope
        ...
        # Converts this scope object into an AWS_SDK::SimpleDB::ItemCollection
