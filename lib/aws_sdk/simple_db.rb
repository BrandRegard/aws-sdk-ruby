...
module AWS_SDK
  ...
  class SimpleDB
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/simple_db') do
    ...
    #
    #   AWS_SDK::SimpleDB.consistent_reads do
    #     # ...
    #   end
    #
    # === Other Modes
    ...
    # default:
    #
    #   AWS_SDK::SimpleDB.consistent_reads(false) do
    #     # ...
    #   end
    # 
    ...
    # @return [Boolean] Returns true if we are inside an AWS_SDK::SimpleDB
