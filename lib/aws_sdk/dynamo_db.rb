...
module AWS_SDK
  ...
  #
  #   dynamo_db = AWS_SDK::DynamoDB.new(
  #     :access_key_id => '...',
  #     :secret_access_key => '...',
  #     :session_token => '...')
  #
  ...
  #
  # @note If you make a request using AWS_SDK::DynamoDB with long-term credentials
  ...
  class DynamoDB
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/dynamo_db') do
