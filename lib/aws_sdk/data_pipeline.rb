...
module AWS_SDK
  ...
  #
  # Or you can set them directly on the AWS_SDK::DataPipeline interface:
  #
  #   datapipeline = AWS_SDK::DataPipeline.new(
  #     :access_key_id => 'YOUR_ACCESS_KEY_ID',
  #     :secret_access_key => 'YOUR_SECRET_ACCESS_KEY')
  #
  # = Using the Client
  #
  # AWS_SDK::DataPipeline does not provide higher level abstractions for AWS Data Pipeline
  # this time.  You can still access all of the API methods using
  # {AWS_SDK::DataPipeline::Client}.  Here is how you access the client and make
  # a simple request:
  #
  ...
  class DataPipeline
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/data_pipeline') do
