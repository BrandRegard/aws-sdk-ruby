...
module AWS_SDK
  ...
  #
  #   cf = AWS_SDK::CloudFront.new(
  #     :access_key_id => 'YOUR_ACCESS_KEY_ID',
  #     :secret_access_key => 'YOUR_SECRET_ACCESS_KEY')
  #
  # = Using the Client
  #
  # AWS_SDK::CloudFront does not provide higher level abstractions for CloudFront at
  # this time.  You can still access all of the API methods using
  # {AWS_SDK::CloudFront::Client}.  Here is how you access the client and make
  # a simple request:
  #
  #   cf = AWS_SDK::CloudFront.new
  #
  ...
  class CloudFront
    ...
    AWS_SDK.register_autoloads(self, 'aws_sdk/cloud_front') do
