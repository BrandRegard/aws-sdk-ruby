...
module AWS_SDK
  class SimpleWorkflow
    ...
    #   #=> #<AWS_SDK::SimpleWorkflow::Domain name:my-domain>
    #
    # == Gettin a Domain
    #
    ...
    #
    # See {AWS_SDK::Core::Collection} to see other useful methods you can 
    ...
    class DomainCollection
      ...
      #   # execution history
      #   domain = AWS_SDK::SimpleWorkflow.new.domains.register('domain', :none)
      #
