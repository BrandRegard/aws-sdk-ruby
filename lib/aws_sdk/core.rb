...
require 'aws_sdk/version'
require 'aws_sdk/core/autoloader'
...
#
# * {AWS_SDK::AutoScaling}
# * {AWS_SDK::CloudFormation}
# * {AWS_SDK::CloudSearch}
# * {AWS_SDK::CloudWatch}
# * {AWS_SDK::DynamoDB}
# * {AWS_SDK::EC2}
# * {AWS_SDK::ElastiCache}
# * {AWS_SDK::ElasticBeanstalk}
# * {AWS_SDK::ELB}
# * {AWS_SDK::EMR}
# * {AWS_SDK::Glacier}
# * {AWS_SDK::IAM}
...
# * {AWS_SDK::STS}
# * {AWS_SDK::SimpleDB}
# * {AWS_SDK::SimpleEmailService}
# * {AWS_SDK::SimpleWorkflow}
#
# = AWS_SDK::Record
#
# In addition to the above services, bundled is an ORM based on AWS services
# See {AWS_SDK::Record} for more information.
#
# = Configuration
#
# You call {AWS_SDK.config} with a hash of options to configure your
# access to the Amazon Web Services.
#
# At a minimum you need to set your access credentials. See {AWS_SDK.config}
...
module AWS_SDK
  ...
  module Core
    ...
    module XML
      ...
      module SaxHandlers
        AWS_SDK.register_autoloads(self, 'aws_sdk/core/xml/sax_handlers') do
  ...
  module Http
    AWS_SDK.register_autoloads(self, 'aws_sdk/core/http') do
  ...
  class << self
    ...
    # values defined in {AWS_SDK.config}.
    #
    ...
    #   The service endpoint for AWS_SDK CloudFormation.
    #
    ...
    #   true, AWS_SDK::DynamoDB::Errors::ProvisionedThroughputExceededException
    ...
    #
    # @option options [Object] :http_handler (AWS_SDK::Core::Http::NetHttpHandler)
    ...
    #
    #     AWS.config(:log_formatter => AWS_SDK::Core::LogFormatter.colored)
    #
    #   Here is a list of pre-configured log formatters:
    #
    #   * +AWS_SDK::Core::LogFormatter.default+
    #   * +AWS_SDK::Core::LogFormatter.short+
    #   * +AWS_SDK::Core::LogFormatter.debug+
    #   * +AWS_SDK::Core::LogFormatter.colored+
    #
    #   You can also create an instance of AWS_SDK::Core::LogFormatter
    ...
    #     AWS.config(:log_formatter => AWS_SDK::Core::LogFormatter.new(pattern))
    #
    ...
    #   If this is set, AWS_SDK::S3::S3Object #read and #write methods will always
    ...
    #   When set to +:instruction_file+, AWS_SDK::S3::S3Object will store
    ...
    #
    # @option options [CredentialProviders::Provider] :credential_provider (AWS_SDK::Core::CredentialProviders::DefaultProvider.new)
    ...
    # {AWS_SDK::EC2::Instance#launch_time} for each instance, causing
    ...
    # subsequent call to {AWS_SDK::EC2::Instance#launch_time} uses the
    ...
    #    (e.g. {AWS_SDK::EC2::Instance#launch_time}), the SDK attempts to
