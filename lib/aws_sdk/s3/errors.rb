...
module AWS_SDK
  class S3
    ...
    module Errors
      ...
      class NotModified < AWS_SDK::Errors::Base

        include AWS_SDK::Errors::ClientError
      ...
      # client error.
      class NoSuchKey < AWS_SDK::Errors::Base
      ...
      #   key is incorrect.
      class IncorrectClientSideEncryptionKey < AWS_SDK::Errors::Base
