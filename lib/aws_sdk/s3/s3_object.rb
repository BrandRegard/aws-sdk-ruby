...
module AWS_SDK
  class S3
    ...
    #   # encrypted/decrypted
    #   s3 = AWS_SDK::S3.new(:s3_encryption_key => "MY_KEY")
    #
    ...
    class S3Object
      ...
      include DataOptions
      include ACLOptions
      include AWS_SDK::S3::EncryptionUtils
      ...
      def decode_envelope_key envelope_key, envelope_iv, encryption_key
        ...
        begin
          ...
          raise AWS_SDK::S3::Errors::IncorrectClientSideEncryptionKey, msg
        end
